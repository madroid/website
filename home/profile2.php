<html language="en">
	<head>
		...
		<link href="profile_css2.css" rel="stylesheet">
	...
	<body>
		...
		<div id="profile_body">
			<div id="col1">
				<div id="user_info" class="myclass">
			...
			<div id="col2">
				<div id="img1" class="myclass item">
					<div>
			...
			<div id="col3">
				<div id="img2" class="myclass item">
					<div>
